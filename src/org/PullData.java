...
public class PullData {
	...
	/**
	 * mainly used to pull Salah's data from the web server and change the format
	 */
	...
	public static void pullDataFromServer(boolean hasDocId) throws Exception{ //
		long startTime = System.currentTimeMillis();
		//URL url = new URL("http://64.56.67.181/vectors.txt");
		URL url = new URL("http://64.56.67.181/data2/vectors.txt");
